    ...
    <div>
      <nav className="navbar">
        ...
        <ul className="nav-links">
          ...
          <li><Link to="/addeventmanager">Add Service Providers</Link></li>
          <li><Link to="/viewmanagers">View Service Providers</Link></li>
          <li><Link to="/viewallcustomers">View Customers</Link></li>
