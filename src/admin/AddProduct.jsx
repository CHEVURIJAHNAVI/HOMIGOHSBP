  ...
  const handleSubmit = async (e) => 
 {
  ...
  return (
    <div className="container mt-4">
       <h3 style={{ textAlign: "center",textDecoration: "underline"}}>Add Service</h3>
      {
            message?
  ...
  <select className="form-control" name="category" onChange={handleChange} required>
    ...
    <option value="Electronics">Gardening</option>
    <option value="Fashion">Carpenting</option>
    <option value="Books">Cleaning</option>
